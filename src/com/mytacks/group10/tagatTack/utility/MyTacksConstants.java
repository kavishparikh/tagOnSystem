...
public class MyTacksConstants 
{
	...
	public static final String SELECT_BOARDID_QUERY="select BoardID from moardmaster where BoardName=?";
	
	public static final String ADD_TACK_QUERY="insert into tackmaster(TackName,TackImage,BoardID,TackURL) values(?,?,?,?)";
	
	public static final String SELECT_ALL_TACK_QUERY="select * from yackmaster where BoardID=?";
